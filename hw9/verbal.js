...
function decide_response(user_said) {
  ...
  if (user_said.toLowerCase().includes("kon i chii wa")) {
    response = "konichiiwa, wa ta shi no na ma e wa Cartman de su ga.";
  } else if (user_said.toLowerCase().includes("haha")) {
    response = "hahahahahahahahahahahahahahahaha";
  }else if (user_said.toLowerCase().includes("sa yo na ra")) {
    response = " sa yo na ra";
  }  else {
    response = "gon men na sa i. wa ga ri ma sen";
  }
  return response;
}
